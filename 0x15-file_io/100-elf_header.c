 ...
 * Description: if the is not ELF file /
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: a pointe to an array containing the elf magic numbers
 * Description: magic numbers are separate by space
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_class - prints the class of an an elf header
 * @e_ident: a pointer an array containing the elf class
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class:");
